...
## Setting up GitHub Repositories for Collaboration {.inverse}
...
1. Create an issue and associated branch on GitHub
...
1. Make an edit to website locally but **don't commit changes**

1. Make edit to website on GitHub.com and save it
...
1. You should have a merge conflict from last lesson
...
## Use gitignore to Avoid Conflicts {.inverse}
